...
# 
# I dati sono relativi ad una serie di dati macroeconomici che forniscono un esempio di regressione altamente
# collineare. I dati si riferiscono al periodo 1947-1962. Le variabili sono le seguenti:
# 1. GNP: prodotto nazionale lordo
# 2. UNEMPLOYED: numero di disoccupati
# 3. ARMED.FORCES: numero di persone nelle forze armate
# 4. POPULATION: numero di popolazione non istituzionalizzata con pi? di 14 anni
...
#-- import dei dati
ABSOLUTE_PATH <- "/Volumes/HDD_Ale/Statistical Modelling/Esercitazioni/2a_Esercitazione - Modelli Generalizzati/R 01 - Modelli Generalizzati/Esercizio 4/longley.txt"
